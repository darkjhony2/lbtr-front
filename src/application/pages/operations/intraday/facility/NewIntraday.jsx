        ...
        <Container fluid style={{ position: 'relative', paddingBottom: 60, minHeight: '100vh' }}>
            <CustomCover>
                <Container fluid className="p-3">
                    <Row>
                        <Col>
                            <span style={{ color: 'gray', borderBottom: '1px solid' }}>Operación {">"} Facilidades Intradía {">"} Nuevo</span>
                        </Col>
                    </Row>
                    <Row style={{ padding: 0 }}>
                    ...
                    <Container fluid className="p-4" style={{ marginTop: 40 }}>
                        <div className="custom">
                            <h6 style={{ width: 220, backgroundColor: 'white', marginTop: '-12px', marginLeft: 40 }}><b style={{ marginLeft: 25 }}>FACILIDAD INTRADÍA</b></h6>
                            <Row>
                                <Col sm={6} style={{ paddingLeft: '5%', paddingTop: '2%', paddingBottom: '2%' }}>
                                    ...
                                    <Row className="mt-2">
                                        <Col style={{ paddingRight: 0, maxWidth: 200 }}>
                                            <Label>Tipo de Facilidad:</Label>
                                        </Col>
                                        <Col sm={8}>
                                            <Input className="textField" value={'FACILIDADES INTRADIA'} disabled type="text" />
                                        </Col>
                                    </Row>
                                    <Row className="mt-2">
                                        <Col style={{ paddingRight: 0, maxWidth: 200 }}>
