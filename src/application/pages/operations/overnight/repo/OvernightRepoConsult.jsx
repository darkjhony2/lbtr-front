...
export const OvernightRepoConsult = () => {
        ...
        <Container fluid style={{ position: 'relative', paddingBottom: 60, minHeight: '100vh' }}>
            <CustomCover>
                <Container fluid className="p-3">
                    <Row>
                        <Col>
                            <span style={{ color: 'gray', borderBottom: '1px solid' }}>Operación {">"} Repo Overnight RON {">"} Consulta</span>
                        </Col>
                    </Row>
                            ...
                            <Table bordered responsive>
                                <thead>
                                    <tr className="lbtr-headrow">
                                        <th>Todos</th>
                                        <th>Nro. Referencia LBTR</th>
                                        <th>Nro. Referencia BCRP</th>
                                        <th>Concepto</th>
                                ...
                                <tbody>
                                    {
                                        consultResults.map((cr, idx) =>
                                            <tr key={idx} className="lbtr-bodyrow">
                                                ...
                                                <td>{cr.lbtrReferenceNumber}</td>
                                                <td>{cr.bcrpReferenceNumber}</td>
                                                <td>{cr.concept}</td>
                                                <td>{cr.expirationDate}</td>
                                                <td>{cr.auctionNumber}</td>
                                                <td>{cr.instrument}</td>
                                                <td>{cr.adjucatedAmount}</td>
                                                <td>{cr.period}</td>
                                                <td>{cr.status}</td>
